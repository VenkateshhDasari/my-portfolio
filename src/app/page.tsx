...
const Home = () => {
  ...
  const projects = [
    {
      title: "HomeMadeDelights Website",
      description: "Production-ready food ordering platform built to handle real customer traffic and live business operations. Users can browse dynamic menus and place delivery or collection orders through a fast, frictionless checkout flow. Optimized for mobile users, repeat ordering, and conversion performance. Designed for scalable cloud deployment and automated order handling.",
      imageSrc: "Home.png",
      LiveUrl: "https://homemade-delights.netlify.app/"
    },
    {
          ...
          <Box id="about" sx={{ pl: { xs: 4, sm: 6, md: 8 }, pt: 3 }}>
            ...
            >
              <>
                ...
                >
                 I’m a <strong>Full-Stack & React Native Developer</strong> building
    <strong> production-ready web and mobile applications</strong> with
    cloud-based APIs and automation-ready architecture for startups and product teams.
    
    <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8, mt: 2 }}>
    I work primarily with <strong>React</strong>, <strong>Next.js</strong>, <strong>Node.js</strong> and <strong>SQL</strong>. 
    I’ve launched <strong>two live cross-platform mobile apps</strong> 
    <strong> WeTasker</strong> and <strong>Task24x7</strong> actively used on Android and iOS, 
    and contributed to <strong>scalable e-commerce systems</strong> handling real business workflows.
  </Typography>
                </Typography>
                ...
                >
                  ...
                  across the UK. I hold a{" "}
                  <strong>2-year Work Permit </strong> valid until May
            ...
            >
              ...
              <List sx={{ color: theme.palette.text.secondary }}>
                ...
                >
                  ...
                  <ListItemText primary="Developed a comprehensive full-stack e-commerce platform that streamlined user interactions and increased customer engagement by 30% through intuitive UI components and optimized state management strategies." />
                </ListItem>
                <ListItem
                  sx={{ paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}
                >
                  ...
                  <ListItemText primary="Designed and implemented over 20 Node.js backend API endpoints that improved data retrieval times by 40%, enhancing overall application performance and user satisfaction across various functionalities.
" />
                </ListItem>
                <ListItem
                  sx={{ paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}
                >
                  ...
                  <ListItemText primary="Configured Docker-based deployments to AWS environments as part of CI/CD workflows, reducing deployment time by 50% while ensuring high availability of services during updates and maintenance periods." />
                </ListItem>
                <ListItem
                  sx={{ paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}
                >
                  ...
                  <ListItemText primary="Conducted rigorous testing and quality assurance processes that identified critical bugs early on, successfully reducing regression issues by 25% and significantly enhancing the application’s stability before launch." />
                </ListItem>
                <ListItem
                  sx={{ paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}
                >
                  ...
                  <ListItemText primary="JWT for secure authentication mechanisms that supported role-based access controls, ensuring data protection across multiple user roles within the e-commerce platform.
" />
                </ListItem>
                <ListItem
                  sx={{ paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}
                >
                  ...
                  <ListItemText primary="utilized Postman and Jest for rigorous API testing and unit/integration test coverage, consistently maintaining 90%+ test coverage and promoting early bug detection." />
                </ListItem>
                 <ListItem
                  sx={{ paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}
                >
